...
function Portfolio() {
  return (
    <div className="main-container-portfolio">
      <div className="navigation-bar-portfolio">
        ...
        <div id="navlinksP">
          <p className="linksP" id="portfolio">
            <NavLink className="m-plus-rounded-1c-regular" to="/">
              Home
            </NavLink>
          </p>
          <hr />
          <p className="linksP" id="about-us">
        ...
        <div className="socials-portfolio">
          <div id="facebook">
            <NavLink
              target="_blank"
      ...
      <div className="logo-header-portfolio">
        <h1 className="give-you-glory-regular" id="title-portfolio">
          Gallery
        </h1>
      </div>
      ...
      <div className="content-block">
        <div className="gallery-container">
          <DisplayFunction className="gallery" />
        </div>
      </div>
    </div>
  );
