  ...
  return (
    <>
      <div className="main-container-quote">
        <div className="navigation-bar-quote">
          ...
          <div id="socials-callout-quote">
            <p>Check us out here!</p>
          </div>

          <div className="socials-container-quote">
            <div id="facebook">
              <NavLink
                target="_blank"
                to="https://www.facebook.com/people/Rusticly-Homemade/61565095627302/?mibextid=LQQJ4d"
              >
                <svg xmlns="http://www.w3.org/2000/svg" height="75px" color="#0D3B66" viewBox="0 0 512 512">
            ...
            <div id="instagram">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" height="75px" color="#0D3B66" viewBox="0 0 448 512">
        ...
        <div className="content-block-quote">
          <h2 className="m-plus-rounded-1c-regular">Contact Us</h2>
